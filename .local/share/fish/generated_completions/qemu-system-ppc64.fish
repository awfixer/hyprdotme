# qemu-system-ppc64
# Autogenerated from man page /usr/share/man/man1/qemu-system-ppc64.1.gz
...
complete -c qemu-system-ppc64 -o audio -d 'This option is a shortcut for configuring both the guest audio hardware and t…'
...
complete -c qemu-system-ppc64 -o hdd -d 'Use file as hard disk 0, 1, 2 or 3 image on the default bus of the emulated m…'
complete -c qemu-system-ppc64 -o cdrom -d 'Use file as CD-ROM image on the default bus of the emulated machine (which is…'
...
complete -c qemu-system-ppc64 -o no-hpet -d 'Disable HPET support.  Deprecated, use \\(aq-machine hpet=off\\(aq instead'
...
complete -c qemu-system-ppc64 -o mon -d 'Set up a monitor connected to the chardev name'
...
complete -c qemu-system-ppc64 -o singlestep -d 'This is a deprecated synonym for the TCG accelerator property one-insn-per-tb'
...
complete -c qemu-system-ppc64 -o chroot -d 'Deprecated, use \\(aq-run-with chroot=. \\(aq instead'
...
complete -c qemu-system-ppc64 -o semihosting-config -d 'Enable and configure \\%Semihosting (ARM, M68K, Xtensa, MIPS, Nios II, RISC-V …'
...
complete -c qemu-system-ppc64 -o async-teardown -d 'This option is deprecated and should no longer be used'
complete -c qemu-system-ppc64 -o run-with -d 'Set QEMU process lifecycle options'
...
complete -c qemu-system-ppc64 -o perfmap -d 'Generate a map file for Linux perf tools that will allow basic profiling info…'
complete -c qemu-system-ppc64 -o jitdump -d 'Generate a dump file for Linux perf tools that maps basic blocks to symbol na…'
...
complete -c qemu-system-ppc64 -o alt-grab -d 'and if you use -ctrl-grab then the modifier is the right Ctrl key (instead of…'
